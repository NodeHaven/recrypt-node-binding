This fork has been created for the express purpose of cross-compiling mobile Recrypt Node bindings.  Similar methodology may be used for cross-compiling other Neon modules. 
